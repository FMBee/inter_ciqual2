...
<script type="text/javascript">
		    ...
		    $(document).ready(function() {
		        ...
		        var table = $('#data-app_logs').DataTable(	{
...
// 		            scrollCollapse: true,
		        ...
		        $('#data-app_logs tbody').children('tr').on( 'click', 'td:eq(0)', function () {

	            	_clicFirstCol = true;
	            }); 
~{*	               
	            $('#data-app_logs').children('tbody').on( 'click', 'tr', function () {

	            	if ( _clicFirstCol && $('#data-app_logs').hasClass('collapsed') ) {		//responsive: affichage des colonnes cachees
	
	            		_clicFirstCol = false;
	            	}
	            	else{
								
  	      	        	_url = '-app_logs&paramkey='+$(this).attr('id');
